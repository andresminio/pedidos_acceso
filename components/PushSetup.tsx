...
export default function PushSetup() {
  ...
  if (estado === "denegado") {
    return (
      <button
        ...
        className="group fixed bottom-[17rem] right-5 z-40 flex h-12 w-12 items-center overflow-hidden rounded-full bg-slate-700 px-2.5 text-white shadow-lg transition-all duration-300 ease-out hover:w-56 hover:bg-slate-600 hover:px-4"
      >
        <span className="flex h-7 w-7 shrink-0 items-center justify-center">
          <IconoCampana />
        </span>
  ...
  return (
    <button
      ...
      className="group fixed bottom-[17rem] right-5 z-40 flex h-12 w-12 items-center overflow-hidden rounded-full bg-blue-600 px-2.5 text-white shadow-lg shadow-blue-950/40 transition-all duration-300 ease-out hover:w-56 hover:bg-blue-500 hover:px-4 disabled:opacity-50"
    >
      <span className="flex h-7 w-7 shrink-0 items-center justify-center">
        <IconoCampana />
      </span>
