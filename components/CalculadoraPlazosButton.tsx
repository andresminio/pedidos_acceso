...
export default function CalculadoraPlazosButton() {
  return (
    <Link
      href="/plazos"
      className="group fixed bottom-[17rem] right-5 z-40 flex h-12 w-12 items-center overflow-hidden rounded-full bg-[var(--surface-3)] px-2.5 text-white shadow-lg transition-all duration-300 ease-out hover:w-56 hover:bg-[var(--muted-3)] hover:px-4"
    >
